...
import logo1 from '../img/home_1/liva.png'
import logo2 from '../img/home_1/kanba.png'
import logo3 from '../img/home_1/amara.png'
import logo4 from '../img/home_1/aven.png'
import logo5 from '../img/home_1/hexlab.png'
const settings = {
    dots: false,
    infinite: true,
    slidesToShow: 3,
...
export const Home2 = () => {
    return (
        <main>
                ...
                <div className="container">
                    <div className="home__content">
                        <div className="home__content-title des">
                            <p className="line"></p> Creative VPN & IT Business Solutions
                        </div>
                        <div className="home__content-name name">
                            World’s Best VPN Service Provider.
                        </div>
            ...
            {/* Phần what */}
            <section className='what bg_gray'>
                <div className="container">
